    ...
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 p-4">
      <div className="bg-white dark:bg-neutral-950 w-full max-w-3xl rounded-2xl shadow-xl border border-neutral-200 dark:border-neutral-800">
        <div className="flex items-center justify-between p-4 border-b border-neutral-200 dark:border-neutral-800">
          ...
          <button className="p-2 hover:bg-neutral-100 dark:hover:bg-neutral-900 rounded-lg" onClick={onClose}>
            <X className="w-5 h-5" />
          </button>
        </div>
          ...
          {isProperty ? (
            <>
              <NumberInput
                ...
                onChange={(v) => setDraft({ ...draft, purchasePrice: v } as PropertyItem)}
                suffix="$"
                step={1000}
              />
              <NumberInput
                ...
                onChange={(v) => setDraft({ ...draft, downPaymentAmount: v } as PropertyItem)}
                suffix="$"
                step={1000}
              />
              <NumberInput
                ...
                onChange={(v) => setDraft({ ...draft, interestRateAPR: v } as PropertyItem)}
                suffix="%"
                step={0.01}
              />
              <NumberInput
                ...
                onChange={(v) => setDraft({ ...draft, termYears: v } as PropertyItem)}
                suffix="years"
                step={1}
              />
              <NumberInput
                ...
                onChange={(v) => setDraft({ ...draft, propertyTaxRate: v } as PropertyItem)}
                suffix="%/yr"
                step={0.01}
              />
              <NumberInput
                ...
                onChange={(v) => setDraft({ ...draft, insuranceAnnual: v } as PropertyItem)}
                suffix="$ / yr"
                step={50}
              />
              <NumberInput
                ...
                onChange={(v) => setDraft({ ...draft, hoaMonthly: v } as PropertyItem)}
                suffix="$ / mo"
                step={10}
              />
              <NumberInput
                ...
                onChange={(v) => setDraft({ ...draft, maintenancePctAnnual: v } as PropertyItem)}
                suffix="% of value / yr"
                step={0.1}
              />
              <NumberInput
                ...
                onChange={(v) => setDraft({ ...draft, pmiAnnualRate: v } as PropertyItem)}
                suffix="%"
                step={0.01}
              />
              <NumberInput
                ...
                onChange={(v) => setDraft({ ...draft, pmiLTVCancel: v / 100 } as PropertyItem)}
                suffix="%"
                step={1}
              />
              <NumberInput
                ...
                onChange={(v) => setDraft({ ...draft, closingCostsPct: v } as PropertyItem)}
                suffix="% of price"
                step={0.1}
              />
              <NumberInput
                ...
                onChange={(v) => setDraft({ ...draft, closingCostsFixed: v } as PropertyItem)}
                suffix="$"
                step={100}
              />
              <NumberInput
                ...
                onChange={(v) => setDraft({ ...draft, pointsPct: v } as PropertyItem)}
                suffix="% of loan"
                step={0.125}
              />
              <NumberInput
                ...
                onChange={(v) => setDraft({ ...draft, originationPct: v } as PropertyItem)}
                suffix="% of loan"
                step={0.1}
              />
              <NumberInput
                ...
                onChange={(v) => setDraft({ ...draft, lenderCredits: v } as PropertyItem)}
                suffix="$ (subtracts)"
                step={100}
              />
            </>
            ...
            <>
              <NumberInput
                ...
                onChange={(v) => setDraft({ ...draft, purchasePrice: v } as VehicleItem)}
                suffix="$"
                step={500}
              />
              <NumberInput
                ...
                onChange={(v) => setDraft({ ...draft, downPaymentAmount: v } as VehicleItem)}
                suffix="$"
                step={250}
              />
              <NumberInput
                ...
                onChange={(v) => setDraft({ ...draft, tradeInValue: v } as VehicleItem)}
                suffix="$"
                step={250}
              />
              <NumberInput
                ...
                onChange={(v) => setDraft({ ...draft, salesTaxRate: v } as VehicleItem)}
                suffix="%"
                step={0.1}
              />
              <Toggle
                ...
                onChange={(v) => setDraft({ ...draft, rollTaxIntoLoan: v } as VehicleItem)}
              />
              <NumberInput
                label="Interest rate (APR)"
                value={(draft as VehicleItem).interestRateAPR}
                onChange={(v) => setDraft({ ...draft, interestRateAPR: v } as VehicleItem)}
                suffix="%"
                step={0.01}
              />
              <NumberInput
                ...
                onChange={(v) => setDraft({ ...draft, termMonths: v } as VehicleItem)}
                suffix="months"
                step={1}
              />
              <NumberInput
                ...
                onChange={(v) => setDraft({ ...draft, insuranceMonthly: v } as VehicleItem)}
                suffix="$ / mo"
                step={10}
              />
              <NumberInput
                ...
                onChange={(v) => setDraft({ ...draft, registrationAnnual: v } as VehicleItem)}
                suffix="$ / yr"
                step={10}
              />
              <NumberInput
                ...
                onChange={(v) => setDraft({ ...draft, maintenanceMonthly: v } as VehicleItem)}
                suffix="$ / mo"
                step={10}
              />
              <NumberInput
                ...
                onChange={(v) => setDraft({ ...draft, oneTimeFees: v } as VehicleItem)}
                suffix="$ upfront"
                step={25}
              />
            </>
        ...
        <div className="flex items-center justify-end gap-2 p-4 border-t border-neutral-200 dark:border-neutral-800">
          ...
          <button className="px-3 py-2 rounded-lg bg-black text-white" onClick={() => onSave(draft)}>
            Save
          </button>
        </div>
      </div>
